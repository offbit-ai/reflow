//! Dynamic range compressor for audio streams.
//!
//! Reduces the volume of loud signals above a threshold. Configurable
//! threshold, ratio, attack, release, and knee. Data frames are raw
//! PCM f32 samples (little-endian).
