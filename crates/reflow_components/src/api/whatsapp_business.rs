...
pub async fn whatsapp_business_send_message(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("POST /{{phone_number_id}}/messages failed: {}", e).into()));
        }
    }
