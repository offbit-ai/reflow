...
pub async fn cohere_generate_text(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("POST /generate failed: {}", e).into()));
        }
    }
...
pub async fn cohere_embed_text(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("POST /embed failed: {}", e).into()));
        }
    }
...
pub async fn cohere_classify_text(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    let inputs = context.get_payload();
    let actor_config = context.get_config();
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("POST /classify failed: {}", e).into()));
        }
    }
