...
pub async fn stability_ai_generate_image(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("POST /generation/{{engine_id}}/text-to-image failed: {}", e).into()));
        }
    }
...
pub async fn stability_ai_list_engines(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    let inputs = context.get_payload();
    let actor_config = context.get_config();
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("GET /engines/list failed: {}", e).into()));
        }
    }
...
pub async fn stability_ai_create_v1alpha_generation(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    let inputs = context.get_payload();
    let actor_config = context.get_config();
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("POST /generation/{{engine_id}}/image-to-image failed: {}", e).into()));
        }
    }
...
pub async fn stability_ai_list_v1alpha_user(context: ActorContext) -> Result<HashMap<String, Message>, Error> {
    let inputs = context.get_payload();
    let actor_config = context.get_config();
    ...
    match builder.send().await {
        ...
        Err(e) => {
            output.insert("error".to_string(), Message::Error(format!("GET /user/account failed: {}", e).into()));
        }
    }
