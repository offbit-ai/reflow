...
pub fn get_actor_for_template(template_id: &str) -> Option<Arc<dyn Actor>> {
    match template_id {
        ...
        "tpl_mysql" => Some(Arc::new(MySQLPoolActor::new())),

        "tpl_postgresql" => Some(Arc::new(PostgreSQLPoolActor::new())),

        "tpl_mongodb" => Some(Arc::new(MongoDbPoolActor::new())),

        // MongoDB Collection Operations
        "tpl_mongo_get_collection" => Some(Arc::new(MongoCollectionActor::new())),
        ...
        // Scripting
        "tpl_javascript_script" => Some(Arc::new(JavaScriptScriptActor::new())),

        "tpl_sql_script" => Some(Arc::new(SqlScriptActor::new())),

        "tpl_python_script" => Some(Arc::new(PythonScriptActor::new())),
...
pub fn get_template_mapping() -> HashMap<String, String> {
    ...
    mapping.insert(
        "tpl_postgresql".to_string(),
        "PostgreSQLPoolActor".to_string(),
    );
